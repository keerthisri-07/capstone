...
export default function AIAssistant() {
  ...
  const handleSend = async (text) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { id: Date.now()+1, role: 'ai', text: "I'm Chitti. For immediate danger, please use the SOS button. For general advice, ensure you are in a safe public place." }])
    } finally {
      setIsTyping(false)
    }
  }
